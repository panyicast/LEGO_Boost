...
class Peripheral(object):
    ...
    def subscribe(self, callback, mode, granularity=1, asyncc=False):
        self._port_subscription_mode = mode
        self.started()
        self._port_subscribe(self._port_subscription_mode, granularity, True)

        self._wait_sync(asyncc)  # having asyncc=True leads to stuck notifications

        if callback:
            self._subscribers.add(callback)

    def unsubscribe(self, callback=None, asyncc=False):
...
class LED(Peripheral):
    ...
    def subscribe(self, callback, mode=None, granularity=None, asyncc=False):
        self._subscribers.add(callback)
...
class EncodedMotor(Peripheral):
    ...
    def timed(self, seconds, speed_primary=1, speed_secondary=None, asyncc=False):
    ...
    def angled(self, angle, speed_primary=1, speed_secondary=None, asyncc=False):
        if speed_secondary is None:
            speed_secondary = speed_primary
    ...
    def constant(self, speed_primary=1, speed_secondary=None, asyncc=False):
        if speed_secondary is None:
            speed_secondary = speed_primary
    ...
    def __some(self, speed_primary=1, speed_secondary=None, asyncc=False):
        if speed_secondary is None:
            speed_secondary = speed_primary
    ...
    def stop(self, asyncc=False):
        self.constant(0, asyncc=asyncc)
    ...
    def subscribe(self, callback, mode=SENSOR_ANGLE, granularity=1, asyncc=False):
...
class TiltSensor(Peripheral):
    ...
    def subscribe(self, callback, mode=MODE_3AXIS_SIMPLE, granularity=1, asyncc=False):
...
class ColorDistanceSensor(Peripheral):
    ...
    def subscribe(self, callback, mode=COLOR_DISTANCE_FLOAT, granularity=1, asyncc=False):
...
class Voltage(Peripheral):
    ...
    def subscribe(self, callback, mode=MODE1, granularity=1, asyncc=False):
...
class Button(Peripheral):
    ...
    def subscribe(self, callback, mode=None, granularity=1, asyncc=False):
        self.started()
